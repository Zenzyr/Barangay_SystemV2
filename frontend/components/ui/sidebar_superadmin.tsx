...
const navigationGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Certificate Templates", url: "/pages/admin/certificate-templates", icon: FileText },
      { title: "Documents", url: "/pages/secretary/barangaySettings/templates", icon: FileText },
      { title: "Rules", url: "/pages/secretary/recommendationRules", icon: SlidersHorizontal },
