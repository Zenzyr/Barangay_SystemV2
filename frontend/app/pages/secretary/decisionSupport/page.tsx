    ...
    <div className={`rounded-2xl border p-5 ${style.bg} ${style.border}`}>
      <div className="flex items-start justify-between gap-3 flex-wrap mb-2">
        <div className="flex items-center gap-2 flex-wrap">
          <span className="text-[11px] font-semibold uppercase tracking-wide text-gray-400">{item.category}</span>
          <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-semibold ${style.iconBg} ${style.iconColor}`}>
      ...
      <div className="mt-3 space-y-2">
        <div className="flex items-start gap-2">
          ...
          <p className="text-xs text-gray-600"><span className="font-semibold text-gray-500">Why: </span>{item.why}</p>
        </div>
        <div className="flex items-start gap-2">
          <Target className={`size-4 shrink-0 mt-0.5 ${style.iconColor}`} />
          <p className="text-xs text-gray-600"><span className="font-semibold text-gray-500">Suggested Action: </span>{item.action}</p>
        </div>
      </div>
    </div>
  );
