...
export interface IDocumentTemplate {
  ...
  /** Ordered render list. zIndex/layer resolvable from element.zIndex. */
  elements: ITemplateElement[];

  // Optional legacy signatory overrides (kept so old data keeps working).
  signatoryConfig?: Record<string, { name: string; position: string; signatureImage?: string }>;
...
const TemplateElementSchema = new Schema(
  {
    ...
    imageFit: { type: String, enum: ["contain", "cover", "stretch"], default: "contain" },
